...
export default {
    ...
    setup(){
        ...
        const makerList = ref(["Telsa" ,"Porsche" ,"Toyota" ,"Honda" ,"Mazda" ,"Mercedes" ,"Lexus" ,"Lamborghini" ,"Audi", "BMW"]);
        const sortList = ref(["Price:Low to High", "Price:High to Low" ,"Newest Arrivals"]);
        ...
        const viewList = computed(() => {
                return carList.filter((car) => car.maker.includes(makerList.value))
        })

        return {makerList, sortList, carList, viewList}
    }
}
</script>