...
export default {
    ...
    setup(){
        ...
        const carList = ref([model3, modelY, modelS, modelX, camry, accord, civic, cx5, cayenne, macan, GLEcoupe, CLA, GLA250, rx350, nx300, urus, aventador, A3, x3, twoSeries]);

        const viewList = computed(() => {
                return carList.value.filter((car) => car.maker.includes(viewCars.value))
        })
    }
}
</script>